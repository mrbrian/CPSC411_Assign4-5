...
data Var_spec = Var_spec1 Ident Array_dimensions
  deriving (Eq, Ord, Show, Read)
...
data Type
    = Type_int | Type_real | Type_bool | Type_char | TypeIdent Ident
  deriving (Eq, Ord, Show, Read)
...
data Data_declaration = Data_declaration1 Ident Cons_declarations
  deriving (Eq, Ord, Show, Read)
...
data Location = Location1 Ident Array_dimensions
  deriving (Eq, Ord, Show, Read)
...
data Var_list
    = Var_list1 Var_list | Var_list2 | Var_list11 Ident More_var_list
  deriving (Eq, Ord, Show, Read)

data More_var_list
    = More_var_list1 Ident More_var_list | More_var_list2
  deriving (Eq, Ord, Show, Read)
